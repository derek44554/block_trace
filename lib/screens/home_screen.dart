...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  return RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final item =
                            _blockToItem(provider.blocks[index]);
            ...
            onPressed: () async {
              ...
              try {
                final conn = context
                    ...
                    .activeConnection;
                if (conn == null) return;
                await BlockApi(connection: conn)
                    .deleteBlock(bid: bid);
  ...
  BlockItem? _blockToItem(BlockModel block) {
    ...
    // 把 bid 解析成真实的 cid + encryptionKey
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            const Center(
              child: Icon(Icons.hub_rounded, size: 18, color: Color(0xFF4A6CF7)),
            ),
            Positioned(
              right: 6,
              top: 6,
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _TagListTile(
                        ...
                        selected: selected,
                        onTap: () {
                          context.read<TraceProvider>().setTag(
                              selected ? null : tag);
                        },
                        onLongPress: () =>
                            _confirmRemoveTag(context, tag),
                      );
                    },
                  );
                },
